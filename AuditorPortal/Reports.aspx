<%@ Page Title="" Language="C#" MasterPageFile="~/Auditor.master" AutoEventWireup="true" CodeFile="Reports.aspx.cs" Inherits="AuditorPortal_Reports" %>
        ...
        <tr>
            ...
            <td style="padding:10px">
                <asp:DropDownList ID="ddlReport" CssClass="dropdown-menu dropdown-menu-site" runat="server">
                    <asp:ListItem>Grievance Kickoff Delay</asp:ListItem>
                    <asp:ListItem>Grievance Resolution Delay</asp:ListItem>
                    <asp:ListItem>Complainant Satisfaction rate</asp:ListItem>
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
